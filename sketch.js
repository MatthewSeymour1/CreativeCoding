...
function setup() {
    ...
    barCharts.push(new MasterChart({
        ...
        yValues: ["Dublin"],
        direction: "vertical",
        title: "Housing Costs in Dublin Over Time",
        xAxisTitle: "Year",
        yAxisTitle: "Average Housing Cost (€)",
        numOfLines: 11,
        chartHeight: 200,
        chartWidth: 400,
        chartPosX: 200,
    ...
    barCharts.push(new MasterChart({
        ...
        title: "Housing Costs in Dublin Over Time",
        xAxisTitle: "Average Housing Cost (€)",
        yAxisTitle: "Year",
        numOfLines: 11,
        chartHeight: 400,
        chartWidth: 200,
    ...
    barCharts.push(new MasterChart({
        ...
        title: "Housing Costs in Major Irish Cities Over Time",
        xAxisTitle: "Year",
        yAxisTitle: "Average Housing Cost (€)",
        numOfLines: 8,
        chartHeight: 150,
    ...
    barCharts.push(new MasterChart({
        ...
        title: "Proportion of Housing Costs in Major Irish Cities Over Time",
        xAxisTitle: "Year",
        yAxisTitle: "Percentage of Total Housing Cost",
        numOfLines: 7,
        chartHeight: 150,
        chartWidth: 450,
        chartPosX: 100,
    ...
    barCharts.push(new MasterChart({
        ...
        relativeOrAbsolute: "relative",
        title: "Proportion of Housing Costs in Major Irish Cities Over Time",
        xAxisTitle: "Percentage of Total Housing Cost",
        yAxisTitle: "Year",
        numOfLines: 7,
        chartHeight: 450,
        chartWidth: 250,
    ...
    barCharts.push(new MasterChart({
        ...
        numOfGridLines: 5,
        titleGap: 30,
        title: "Average House Price in Dublin (Euro) Over Time (Years)",
    }));
}
